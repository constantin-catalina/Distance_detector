/**
 * @file PitchesDefinitions.h
 * @brief Note frequency definitions for audio output
 * @author catalina
 */

#ifndef PITCHES_DEFINITIONS_H
#define PITCHES_DEFINITIONS_H
